...
NAME = 'wifimaster'
AUTHOR = 'El Sigei'
AUTHOR_EMAIL = 'b.monk03@gmail.com'
LICENSE = 'LINUX'
VERSION = get_version()
URL = 'https://github.com/lordemonk70/wifimaster'
DESCRIPTION = get_description()
KEYWORDS = ["wifimaster", "limit", "bandwidth", "network"]
...
CLASSIFIERS = ['Development Status :: 3 - Alpha',
               ...
               'License :: OSI Approved :: LINUX license',
...
PYTHON_REQUIRES = '>= 3'
ENTRY_POINTS = { 'console_scripts': ['wifimaster = wifimaster.wifimaster:run'] }
